    ...
    <div className="flex">
      <div className="bg-white lg:w-[30%] w-[100%] h-[100vh] flex items-center justify-center p-3">
        ...
        <form className="flex flex-col gap-4 items-center justify-center w-full" onSubmit={handleSubmit}>
          ...
          <button className="h-[44px] mt-4 w-full inline-block shrink-0 rounded-md border bg-[#15ABFF] px-12  text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500" disabled={isLoading}>
          {isLoading ? 'Signing up...' : 'Sign Up'}
          </button>


          <Link  className="text-[#15ABFF] text-[12px] flex items-start justify-start mr-[54%] mt-6 hover:underline whitespace-nowrap"  to={"/"}>Already have an account? Login in</Link>
        </form>
      </div>
